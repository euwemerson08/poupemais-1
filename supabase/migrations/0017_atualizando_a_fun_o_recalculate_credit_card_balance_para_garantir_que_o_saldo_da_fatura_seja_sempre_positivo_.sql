...
BEGIN
    ...
    IF v_current_invoice_id IS NOT NULL THEN
        ...
        -- Multiplica por -1 para obter um valor positivo, já que as despesas são armazenadas como negativas
        SELECT COALESCE(SUM(amount * -1), 0) INTO v_current_invoice_balance
